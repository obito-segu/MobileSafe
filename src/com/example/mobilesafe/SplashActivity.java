...
//				Toast.makeText(getApplicationContext(), "服务器路径错误", Toast.LENGTH_LONG).show();
//				break;
//			case SERVER_ERROR:
...
//		PackageManager packageManager=this.getPackageManager();//得到系统的包管理器
//		try {
...
//		}.start();
	...
	//由sp对象来获取autoupdate所对应的boolean值，如果该键不存在，默认返回true
			...
			try {
				//获取服务端的配置信息的连接地址
				String serverurl = getResources().getString(R.string.severurl);
				URL url = new URL(serverurl);
